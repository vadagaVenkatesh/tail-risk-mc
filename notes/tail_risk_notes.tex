...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item \textbf{Estimate ES, and prefer EVT in the tail.} ES integrates the
        ...
        here tracked reality most closely (breach rates 5.00\% and 0.97\%).
  \item \textbf{Breaches cluster.} Both the data and Figure~\ref{fig:breaches}
        show exceedances arriving in bursts, violating the independence that
        simple VaR assumes --- which is why conditional (e.g.\ GARCH-filtered)
        and dynamic-EVT approaches exist.
\end{enumerate}
...
python3 backtest.py        # Kupiec backtest vs realised losses
