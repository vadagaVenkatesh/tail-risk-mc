...
its threshold is this sample's 90th percentile. A rolling out-of-sample backtest
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item \textbf{Passing Kupiec is not the number being right.} Breaches
        ...
        at 95\%. A fatter tail cannot fix that; only a \emph{conditional} VaR
        that moves with current volatility (e.g.\ GARCH-filtered EVT) can.
\end{enumerate}
